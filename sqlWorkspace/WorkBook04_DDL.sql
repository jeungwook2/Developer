...
ALTER TABLE TB_CATEGORY RENAME CONSTRAINT PRIMARY_KEY TO PK_NAME;
ALTER TABLE TB_CLASS_TYPE RENAME CONSTRAINT PRIMARY_KEY TO PK_NO;
...
ALTER TABLE TB_DEPARTMENT ADD CONSTRAINT FK_CATEGORY FOREIGN KEY (CATEGORY) REFERENCES TB_CATEGORY (CATEGORY_NAME);
...
CREATE OR REPLACE VIEW 학과별학생수
AS
    SELECT D.DEPARTMENT_NAME, COUNT(S.STUDENT_NO) AS 학생수
